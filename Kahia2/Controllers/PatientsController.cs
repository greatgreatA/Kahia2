...
namespace Kahia2.Controllers
{
    public class PatientsController : Controller
    {
        private readonly Kahia2Context _context;

        public PatientsController(Kahia2Context context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPatient,Poids,SituationMatrimoniale,GroupeSanguin,Age,Taille,Sexe")] Patient patient)
        {
